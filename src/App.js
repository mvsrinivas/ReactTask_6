...
import './App.css';
import abhiImage from "./srinivas.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="srinivas" />
          <h3 className="name">srinivas</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>srinivas</span></h1>
      </section>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> mvenkatasrinivas12@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 8555060243 </h3>
